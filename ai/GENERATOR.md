...
> 줄 번호는 `chain.py` **603줄 기준(2026-09-09)** 입니다. 상수 이름을 같이 적어 뒀으니
> 줄이 밀리면 이름으로 찾으십시오.
...
> **현재 채택 모델은 `JunHowie/Qwen3-14B-GPTQ-Int4` 입니다**(§1 참고). 같은 Qwen3-14B 를
> 양자화 방식만 바꾼 것이며, AWQ→GPTQ 교체 근거는 §1 의 2026-09-09 변경(1) 표에 있습니다.
> 아래 표를 현재 모델의 성능으로 읽지 마십시오.
